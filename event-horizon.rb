class EventHorizon < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Automattic/EventHorizon/releases/download/0.2.2/event-horizon-cli-darwin-arm64",
        using: :nounzip
  ...
  on_linux do
    on_intel do
      url "https://github.com/Automattic/EventHorizon/releases/download/0.2.2/event-horizon-cli-linux-amd64",
        using: :nounzip
